...
import { Brain, Plus, Trash2, Play, ExternalLink, Users, Clock } from "lucide-react";
...
export function QuizAdminList({ sessions }: { sessions: QuizSessionListItem[] }) {
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-2xl">
            ...
            Create a session, seed it from the field guide, and host it
            live with the Control Room.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            guide (six conversation areas, four postures).
          </CardDescription>
        </CardHeader>
